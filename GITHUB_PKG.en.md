...
See [SCRIPTS.md](SCRIPTS.en.md) for the full hook authoring guide.
...
- [SCRIPTS.md](SCRIPTS.en.md) — Scripting Guide (fetch sources, six hook kinds)
- [README.md](README.en.md) — Project homepage
